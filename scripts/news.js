...
angular.module('emptyatlasgithubioApp').service('NewsService', function () {
    ...
    this.newsList = [{
        date: '12.7.16',
        content: `Good gravy. I haven’t posted anything in months, so let’s run through the big stuff briefly.<br><br>First: We released a music video for the debut single from “Hestia,” called “House Fire,” and we’re really stoked about the feedback we’ve received. A ton of people have been sharing and liking it on YouTube, and I really appreciate that. Big ups to Clay Hardwick at <a href="http://echomech.com/" target="_blank">Echomech Creative</a> for making that for us!<br><br>Second: “Hestia” releases in just two days! It’ll be out this Friday, Dec. 9, on iTunes, Amazon, Spotify, Apple Music, and just about everywhere else, so please check it out and let me know what you think. It was a blast making it, and I’m super proud of the songs on it. Hope you like them to. You can also preorder it on <a href="https://itunes.apple.com/us/album/hestia/id1172021169" target="_blank">iTunes</a> now, if you feel so inclined.<br><br>Third: I’ll be playing an album release show for “Hestia” on Thursday, Dec. 15, at Big Sleepy’s in Jackson, and while we can, we’ll be giving out copies of the album with admission. I’ll have all the guys who recorded the album with me – Jacob Walker on guitar, Chris Graham on bass, Sanders Reid on drums – and we’ll be playing several songs from the album live for the first time, so please come out if you live in the Jackson area!<br><br>I’m so excited to be this close to “Hestia” being in everyone’s hands! It’s been a tremendously long and tough process writing, recording, handling the legal and business stuff, all in the midst of still booking shows and performing, but I really love doing this and appreciate the people who have been kind enough to say hey at a show and buy a t-shirt or CD. Thanks, all.<br><br>Micah`
    },{
        date: '4.7.16',
